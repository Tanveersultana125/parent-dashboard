...
export const SubjectMasteryRadar = ({
  ...
  // Truncate long subject names for axis. Full name lives in the tooltip.
  ...
  // Reserve header strip for the avg pill if requested.
  ...
  return (
    <div style={{ width: "100%" }}>
      ...
      {/* Quiet brand accent — uses caller-provided color so the chart still
          feels native to its dashboard despite the tier-colored bars. */}
      <div
        aria-hidden
        style={{
          height: 2,
